...
public class Constants {
    ...
    GET_VICTIM_CONSENT, ASSIGN_TO_LAW }
    
    enum InvestigationOperations { GET_INVESTIGATION_REQUESTS, 
    ASSIGN_TO_INVESTIGATION, ASSIGN_TO_MANAGER, ASSIGN_TO_TESTING, 
    SELECT_INVESTIGATION_STAFF, ASSIGN_STAFF, ASSIGN_TO_ADMIN, ASSIGN_TO_HOSPITAL, GET_EMAIL_INVESTIGATION_REQUESTS }
    ...
    enum Status {
        ...
        SHARED_WITH_MANAGEMENT, REPORT_SHARED, PENDING_VICTIM_CONSENT, ASSIGNED_TO_JUDGE
    }
